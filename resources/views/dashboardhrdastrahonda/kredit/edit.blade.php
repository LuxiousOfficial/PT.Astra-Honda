                ...
                <form action="/dashboardhrdastrahonda/kredit/{{ $kredit->id }}" method="post">
                  ...
                  @csrf
                    ...
                    <div data-mdb-input-init class="form-outline mb-4">
                      ...
                      <input type="number" id="nohp" name="nohp" class="form-control form-control-lg @error('nohp')is-invalid @enderror" placeholder="Ketik tempat Lahir anda..." required value="{{ old('nohp', $kredit->nohp) }}"/>
                      @error('nohp')
                      <div class="invalid-feedback">{{ $message }}</div>
                      @enderror
                    </div>
