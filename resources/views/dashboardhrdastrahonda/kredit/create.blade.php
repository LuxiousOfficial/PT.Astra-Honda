          ...
          <div class="container-fluid mt-3">
              <div class="row">
                  <div class="col-xxl-12 col-xl-12 col-md-12 col-12">
                      <form action="/dashboardhrdastrahonda/kredit" method="post">
                        @csrf
                          ...
                          <div data-mdb-input-init class="form-outline mb-4">
                            ...
                            <input type="text" id="pesan" name="pesan" class="form-control form-control-lg @error('pesan')is-invalid @enderror" placeholder="Ketik pesan anda..." required value="{{ old('pesan') }}"/>
                            @error('pesan')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                          </div>
