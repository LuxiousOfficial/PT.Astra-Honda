                    ...
                    <form action="/dashboardhrdastrahonda/service/{{ $service->id }}" method="post">
                      ...
                      @csrf
                        <div data-mdb-input-init class="form-outline mb-4">
                            ...
                            <input type="text" id="nama" name="nama" class="form-control form-control-lg @error('nama')is-invalid @enderror" placeholder="Ketik nama lengkap anda..." required value="{{ old('nama', $service->nama) }}"/>
                            @error('nama')
                        ...
                        <div data-mdb-input-init class="form-outline mb-4">
                          ...
                          <input type="email" id="email" name="email" class="form-control form-control-lg @error('email')is-invalid @enderror" placeholder="Ketik alamat email anda..." required value="{{ old('email', $service->email) }}"/>
                          @error('email')
                          <div class="invalid-feedback">{{ $message }}</div>
                          @enderror
                        </div>
                        ...
                        <div data-mdb-input-init class="form-outline mb-4">
                          ...
                          <input type="number" id="nohp" name="nohp" class="form-control form-control-lg @error('nohp')is-invalid @enderror" placeholder="Ketik tempat Lahir anda..." required value="{{ old('nohp', $service->nohp) }}"/>
                          @error('nohp')
                          <div class="invalid-feedback">{{ $message }}</div>
                          @enderror
                        </div>
                        ...
                        <div data-mdb-input-init class="form-outline mb-4">
                          ...
                          <input type="text" id="alamat" name="alamat" class="form-control form-control-lg @error('alamat')is-invalid @enderror" placeholder="Ketik Alamat anda..." required value="{{ old('alamat', $service->alamat) }}"/>
                          @error('alamat')
                          <div class="invalid-feedback">{{ $message }}</div>
                          @enderror
                        </div>
                        ...
                        <div data-mdb-input-init class="form-outline mb-4">
                            ...
                            <select class="form-select" aria-label="Default select example" id="provinsi" name="provinsi">
                              <option selected>{{ $service->provinsi }}</option>
                        ...
                        <div data-mdb-input-init class="form-outline mb-4">
                          ...
                          <input type="text" id="kota" name="kota" class="form-control form-control-lg @error('kota')is-invalid @enderror" placeholder="Ketik kota anda..." required value="{{ old('kota', $service->kota) }}"/>
                          @error('kota')
                          <div class="invalid-feedback">{{ $message }}</div>
                          @enderror
                        </div>
                        ...
                        <div data-mdb-input-init class="form-outline mb-4">
                            ...
                            <option selected>{{ $service->kategorimotor }}</option>
                        ...
                        <div data-mdb-input-init class="form-outline mb-4">
                            ...
                            <select class="form-select" aria-label="Default select example" id="varianmotor" name="varianmotor">
                              <option selected>{{ $service->varianmotor }}</option>
                        ...
                        <div data-mdb-input-init class="form-outline mb-4">
                          ...
                          <option selected>{{ $service->tahunpembuatan }}</option>
                        ...
                        <div data-mdb-input-init class="form-outline mb-4">
                          ...
                          <option selected>{{ $service->jenisservice }}</option>
                        ...
                        <div data-mdb-input-init class="form-outline mb-4">
                            ...
                            <input type="date" id="jadwal" name="jadwal" class="form-control form-control-lg w-50 @error('jadwal')is-invalid @enderror" placeholder="Pilih jadwal anda..." required value="{{ old('jadwal', $service->jadwal) }}"/>
                            @error('jadwal')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                          </div>
                        ...
                        <div data-mdb-input-init class="form-outline mb-4">
                          ...
                          <select class="form-select" aria-label="Default select example" id="jam" name="jam">
                            <option selected>{{ $service->jam }}</option>
