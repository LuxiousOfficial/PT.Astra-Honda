                    ...
                    <form method="post" action="/user/experience">
                      @csrf
                        <div data-mdb-input-init class="form-outline mb-4">
                          ...
                          <input type="text" id="company" name="company" autofocus="true" class="form-control form-control-lg @error('company')is-invalid @enderror" placeholder="Ketik nama perusahaan anda..." required value="{{ old('company') }}"/>
                          @error('company')
                        ...
                        <div data-mdb-input-init class="form-outline mb-4">
                          ...
                          <input type="text" id="position" name="position" class="form-control form-control-lg @error('position')is-invalid @enderror" placeholder="Ketik posisi anda..." required value="{{ old('position') }}"/>
                          @error('position')
                          <div class="invalid-feedback">{{ $message }}</div>
                          @enderror
                        </div>
                          ...
                          <div data-mdb-input-init class="form-outline mb-4">
                            ...
                            <input type="date" id="year_stopped" name="year_stopped" class="form-control form-control-lg w-50 @error('year_stopped')is-invalid @enderror" placeholder="Ketik tahun resain anda..." required value="{{ old('year_stopped') }}"/>
                            @error('year_stopped')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                          </div>
                          ...
                          <div data-mdb-input-init class="form-outline mb-4">
                            ...
                            <input type="text" id="salary" name="salary" class="form-control form-control-lg @error('salary')is-invalid @enderror" placeholder="Ketik gaji yang anda terima saat ini..." required value="{{ old('salary') }}"/>
                            @error('salary')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                          </div>
                          ...
                          <div data-mdb-input-init class="form-outline mb-4">
                            ...
                            <input type="text" id="facility" name="facility" class="form-control form-control-lg @error('facility')is-invalid @enderror" placeholder="Ketik Fasilitas anda..." required value="{{ old('facility') }}"/>
                            @error('facility')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                          </div>
                          ...
                          <div class="mb-3">
                            <label class="form-label fw-bold" for="reason_to_stop">Alasan Resain</label>
                            <textarea class="form-control @error('reason_to_stop')is-invalid @enderror" id="reason_to_stop" name="reason_to_stop" rows="3" required value="{{ old('reason_to_stop') }}"></textarea>
