    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-md-2 col-sm-4 col-4 mt-5 text-light text-capitalize">
          ...
          <div class="link">
            <a class="text-decoration-none text-light fs-6" href="/corporate">profile</a> <br>
            <a class="text-decoration-none text-light fs-6" href="/corporate">visi misi</a> <br>
            <a class="text-decoration-none text-light fs-6" href="/corporate">one heart</a> <br>
            <a class="text-decoration-none text-light fs-6" href="/corporate">sejarah</a> <br>
            <a class="text-decoration-none text-light fs-6" href="/corporate">main dealer</a> <br>
            <a class="text-decoration-none text-light fs-6" href="#">social responsibility</a> <br>
            <a class="text-decoration-none text-light fs-6" href="/corporate">penghargaan</a> <br>
            <a class="text-decoration-none text-light fs-6" href="/karirs">karir</a> <br>
        ...
        <div class="col-md-2 col-sm-4 col-4 mt-5 text-light text-capitalize">
          ...
          <div class="link">
            <a class="text-decoration-none text-light fs-6" href="/products">honda matic</a> <br>
            <a class="text-decoration-none text-light fs-6" href="/products">honda bebek</a> <br>
            <a class="text-decoration-none text-light fs-6" href="/products">honda sport</a> <br>
        ...
        <div class="col-md-2 col-sm-4 col-4 mt-5 text-light text-capitalize">
          ...
          <div class="link">
            <a class="text-decoration-none text-light fs-6" href="/releases">press release</a> <br>
          </div>
        </div>
        <div class="col-md-2 col-sm-4 col-4 mt-5 text-light text-capitalize">
