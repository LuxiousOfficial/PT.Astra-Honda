        ...
        <div class="container-fluid mt-3">
            <div class="row">
                <div class="col-xxl-12 col-xl-12 col-md-12 col-12">
                    <form method="post" action="/astra/pelamar/{{ $pelamar->id }}" enctype="multipart/form-data">
                        @method('put')
                        @csrf
                        <div data-mdb-input-init class="form-outline mb-4">
                          ...
                          <div data-mdb-input-init class="form-outline mb-4">
                            ...
                            <input type="text" id="nik" name="nik" class="form-control form-control-lg @error('nik')is-invalid @enderror" placeholder="Ketik nik anda..." required value="{{ old('nik', $pelamar->nik) }}"/>
                            @error('nik')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                          </div>
                          ...
                          <div data-mdb-input-init class="form-outline mb-4">
                            ...
                            <input type="text" id="nohp" name="nohp" class="form-control form-control-lg @error('nohp')is-invalid @enderror" placeholder="Ketik tempat Lahir anda..." required value="{{ old('nohp', $pelamar->nohp) }}"/>
                            @error('nohp')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                          </div>
