...
class HrdPelamarController extends Controller
{
    /**
    ...
    public function index(Pelamar $pelamar)
    {
        ...
        return view('dashboardhrdastrahonda.pelamar.index', [
    ...
    {
        return view('dashboardhrdastrahonda.pelamar.create', [
    ...
    public function store(Request $request)
    {
        ...
        return redirect('dashboardhrdastrahonda/pelamar')->with('success', 'Data yang anda kirim berhasil tersimpan ke dalam database kami, Good Luck!!');
    }
    ...
    {
        Gate::authorize('admin', $pelamar);
        return view('dashboardhrdastrahonda.pelamar.show', [
            'pelamar' => $pelamar
        ]);
    }
    ...
    {
        Gate::authorize('admin', $pelamar);
        return view('dashboardhrdastrahonda.pelamar.edit', [
            'pelamar' => $pelamar,
            'karirs' => Karir::latest('id')->get()
        ]);
    }
    ...
    public function update(Request $request, Pelamar $pelamar)
    {
        ...
        return redirect('dashboardhrdastrahonda/pelamar')->with('update', 'Data berhasil diubah');
    }
    ...
    public function destroy(Pelamar $pelamar)
    {
        ...
        return redirect('/dashboardhrdastrahonda/pelamar')->with('success', 'Data berhasil dihapus');
    }
}
