...
class HrdKreditController extends Controller
{
    /**
    ...
    public function index(Kredit $kredit)
    {
        ...
        return view('dashboardhrdastrahonda.kredit.index', [
    ...
    {
        return view('dashboardhrdastrahonda.kredit.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/dashboardhrdastrahonda/kredit')->with('success', 'Data yang anda kirimkan sudah tersimpan ke dalam database kami, Terima Kasih...!!!');
    }
    ...
    {
        Gate::authorize('admin', $kredit);
        return view('dashboardhrdastrahonda.kredit.show', [
            'kredit' => $kredit
        ]);
    }
    ...
    {
        Gate::authorize('admin', $kredit);
        return view('dashboardhrdastrahonda.kredit.edit', [
            'kredit' => $kredit
        ]);
    }
    ...
    public function update(Request $request, Kredit $kredit)
    {
        ...
        return redirect('/dashboardhrdastrahonda/kredit')->with('update', 'Data berhasil diubah');
    }
    ...
    public function destroy(Kredit $kredit)
    {
        ...
        return redirect('/dashboardhrdastrahonda/kredit')->with('success', 'Data berhasil dihapus');
    }
}
